...
class _VisitStoreScreenState extends State<VisitStoreScreen> {
  ...
  void initState() {
    _supplierProducts = Provider.of<ProductProvider>(context, listen: false)
        .productsBySupplierId(widget.supplier.id!);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final currentSupplier = Provider.of<AuthSupplierProvider>(context).supplier;
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
              ...
              child: ClipRRect(
                ...
                child: Hero(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    image: widget.supplier.storeLogoUrl!,
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          widget.supplier.storeName.toString(),
